...
export PATH=$HOME/repos/gitlab/snapplesauce/dotfiles/scripts/:$PATH
...
#for xserver
#alias xlaunch='/c/ProgramData/Microsoft/Windows/Start\ Menu/Programs/VcXsrv  -run ~/documents/config.xlaunch'
